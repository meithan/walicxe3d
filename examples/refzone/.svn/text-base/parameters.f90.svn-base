...
module parameters
  ...
  real, parameter :: dtout = 1000 * YR     !< Time between data dumps (s)
  ...
  integer, parameter :: p_maxcells_y = 1024
  ...
  integer, parameter :: bc_left   = BC_FREE_FLOW     !< BC type on LEFT face
  integer, parameter :: bc_right  = BC_FREE_FLOW     !< BC type on RIGHT face
  integer, parameter :: bc_front  = BC_FREE_FLOW     !< BC type on FRONT face
  integer, parameter :: bc_back   = BC_FREE_FLOW     !< BC type on BACK face
  integer, parameter :: bc_bottom = BC_FREE_FLOW     !< BC type on BOTTOM face
  integer, parameter :: bc_top    = BC_FREE_FLOW     !< BC type on TOP face
