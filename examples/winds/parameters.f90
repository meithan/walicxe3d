...
module parameters
  ...
  real, parameter :: tfin = 25 * KYR      !< Final integration time (s)
  real, parameter :: dtout = 1 * KYR     !< Time between data dumps (s)
  ...
  real, parameter :: xphystot = 1 * PC      !< Physical domain size along x
  real, parameter :: yphystot = 1 * PC      !< Physical domain size along y
  real, parameter :: zphystot = 1 * PC      !< Physical domain size along z
